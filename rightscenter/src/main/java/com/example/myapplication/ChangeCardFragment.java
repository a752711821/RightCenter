        ...
        client.newCall(request).enqueue(new Callback() {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                try {
                    ...
                    final String leftTitle = jsonArray.getJSONObject(4).getString("leftTitle");
                    final String leftDesc = jsonArray.getJSONObject(4).getString("leftDesc");
                    final String rightNumber = jsonArray.getJSONObject(4).getString("rightNumber");
                    final String rightTitle = jsonArray.getJSONObject(4).getString("rightTitle");
                    String bottomImgUrl = jsonArray.getJSONObject(4).getString("bottomImgUrl");
                    final String rightImage = jsonArray.getJSONObject(4).getString("rightImage");
                    final String bottomBtnName = jsonArray.getJSONObject(4).getString("bottomBtnName");
