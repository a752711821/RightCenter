...
public class IntegralFragment extends Fragment {
    ...
    ArrayList<UserRightInfoVO.ListBean.DataBean> infoVOS;
        ...
        client.newCall(request).enqueue(new Callback() {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                try {
                    ...
                    final String leftTitle = jsonArray.getJSONObject(1).getString("leftTitle");
                    final String leftDesc = jsonArray.getJSONObject(1).getString("leftDesc");
                    final String rightNumber = jsonArray.getJSONObject(1).getString("rightNumber");
                    final String rightTitle = jsonArray.getJSONObject(1).getString("rightTitle");
                    final String bottomImgUrl = jsonArray.getJSONObject(1).getString("bottomImgUrl");
                    String rightImage = jsonArray.getJSONObject(1).getString("rightImage");
                    final String bottomBtnName = jsonArray.getJSONObject(1).getString("bottomBtnName");
