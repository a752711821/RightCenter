...
public class OverdraftFragment extends Fragment {
        ...
        client.newCall(request).enqueue(new Callback() {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                try {
                    ...
                    final String leftTitle = jsonArray.getJSONObject(5).getString("leftTitle");
                    final String leftDesc = jsonArray.getJSONObject(5).getString("leftDesc");
                    final String rightNumber = jsonArray.getJSONObject(5).getString("rightNumber");
                    final String rightTitle = jsonArray.getJSONObject(5).getString("rightTitle");
                    String bottomImgUrl = jsonArray.getJSONObject(5).getString("bottomImgUrl");
                    final String rightImage = jsonArray.getJSONObject(5).getString("rightImage");
                    final String bottomBtnName = jsonArray.getJSONObject(5).getString("bottomBtnName");
